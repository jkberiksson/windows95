...
export default function About({ setShowAbout }) {
    return (
        <Modal
            className='w-[360px] md:w-[450px] h-[50vh] md:h-[550px] left-3 md:left-[4vw] flex flex-col'
            style={{ top: '5vh' }}
                ...
                <Frame h='100%' bgColor='$material' boxShadow='$out' padding='$4'>
                    <Frame h='100%' bgColor='white' boxShadow='$in' padding='$8' className='overflow-y-scroll custom-scrollbar'>
                        ...
                        <p className='mb-2'>
                            ...
                            experiences. I don’t really have a “typical” day — I just kind of roll with whatever comes my way. I’ve had my
                            fair share of ups and downs, but that’s all part of the fun, right? I think life is about figuring things out as
                            you go, and sometimes it’s messy, but that’s where the good stuff happens.
                        </p>
                        <p className='mb-2'>
                            I’ve always had a thing for trying new things, whether it’s learning a new skill or picking up a random hobby
                            just to see what happens. Sometimes I fail, but hey, that’s how you learn! I’m not afraid to take risks or step
                            out of my comfort zone, and I think that’s the only way to really grow.
                        </p>
                        <p>
                            One of my favorite things is just chatting with people and hearing their stories — everyone has something
                            interesting to share, and I find that super inspiring. Whether I’m lost in a good book or hanging out with
                            friends, I’m always trying to soak up everything I can from the world around me. Life’s too short to take too
                            seriously, so I try to keep things light, fun, and full of surprises.
                        </p>
                        <img
